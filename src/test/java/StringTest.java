...
public class StringTest {
    ...
    @Test
    @DisplayName("String의 charAt() 메소드를 활용해 특정 위치의 문자를 가져올 때 위치 값을 벗어나면 StringIndexOutOfBoundsException이 발생하는 부분에 대한 테스트")
    public void Test3_2() {
        String source = "abc";
    ...
    @Test
    @DisplayName("JUnit의 @DisplayName을 활용해 테스트 메소드의 의도를 표시")
    public void Test3_3() {
        String source = "TEST";
